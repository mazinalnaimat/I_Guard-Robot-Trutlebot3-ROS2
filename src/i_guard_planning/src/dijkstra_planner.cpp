...
#include "i_guard_planning/dijkstra_planner.hpp"

namespace i_guard_planning
{
...
PLUGINLIB_EXPORT_CLASS(i_guard_planning::DijkstraPlanner, nav2_core::GlobalPlanner)